  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragging && "z-10 bg-muted/50 shadow-lg"
      )}
    >
      {/* Drag handle */}
      <button
        type="button"
        className="flex shrink-0 items-center justify-center mt-1.5 cursor-grab text-muted-foreground/40 hover:text-muted-foreground active:cursor-grabbing touch-none"
        {...attributes}
        {...listeners}
      >
